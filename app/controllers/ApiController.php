...
class ApiController
{
    ...
    public function create_profile()
    {
        ...
        if($this->apiModel->middleware_auth($token)) {
            ...
            // On fait l'ajout en base de données
            $addedUser = $this->apiModel->create_profile($data);
            ...
            if($addedUser == null) {
                ...
                header('Content-Type: application/json');
                http_response_code(200);
                echo json_encode(['success' => 'Utilisateur ajouté avec succès', 'id' => $addedUser], JSON_UNESCAPED_UNICODE);
                exit;
            }
        }
    }
    ...
    public function edit_Company($id)
    {
        ...
        if($this->apiModel->middleware_auth($token)) {
            ...
            // On fait la modification en base de données
            $editedCat = $this->apiModel->edit_Company($id, $data);
            ...
            if($editedCat !== null) {
                ...
                header('Content-Type: application/json');
                http_response_code(200);
                echo json_encode(['success' => 'Entrée modifiée avec succès'], JSON_UNESCAPED_UNICODE);
                exit;
            }
        }
    }
    ...
    public function delete_Company()
    {
        ...
        if($this->apiModel->middleware_auth($token)) {
            ...
            // On fait la suppression en base de données
            $deletedCat = $this->apiModel->delete_Company($data['id']);
            ...
            if($deletedCat !== null) {
                ...
                header('Content-Type: application/json');
                http_response_code(200);
                echo json_encode(['success' => 'Entrée supprimé avec succès'], JSON_UNESCAPED_UNICODE);
                exit;
            }
        }
    }
    ...
    public function create_Company()
    {
        ...
        if($this->apiModel->middleware_auth($token)) {
            ...
            // On fait l'ajout en base de données
            $addedCat = $this->apiModel->create_Company($data);
            ...
            if($addedCat == null) {
                ...
                header('Content-Type: application/json');
                http_response_code(200);
                echo json_encode(['success' => 'Entrée ajouté avec succès', 'id' => $addedCat], JSON_UNESCAPED_UNICODE);
                exit;
            }
        }
    }
